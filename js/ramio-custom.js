...
$(function() {
  ...
  if(bgndKenburns1.length){
    bgndKenburns1.vegas({
      ...
      transitionDuration: 2000,
      slides: [
        { src: "img/backgrounds/pexels-vojtech-okenka-392018.jpg" },
        { src: "img/backgrounds/annie-spratt-g9KFpAfQ5bc-unsplash.jpg" },
  ...
  if(bgndKenburns1.length){
    bgndKenburns1.vegas({
      ...
      transitionDuration: 2000,
      slides: [
        { src: "img/backgrounds/ppexels-vojtech-okenka-392018.jpg" },
        { src: "img/backgrounds/annie-spratt-g9KFpAfQ5bc-unsplash.jpg" },
        { src: "img/backgrounds/cleo-vermij-dFwtwXRQ2yQ-unsplash.jpg" }
      ],
      animation: [ 'kenburnsUp', 'kenburnsDown', 'kenburnsLeft', 'kenburnsRight' ]
    });
  }
